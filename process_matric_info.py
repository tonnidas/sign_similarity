...
def countMatched(inputDF):
    ...
    for index, row in inputDF.iterrows():
        ...
        "totalWords":len(row['groundTruthWords']), "totalNoun":len(row['Noun']), "totalConj":0 , "totalAdj":len(row['Adjective']), "totalVerbs":len(row['Verb']), "totalAdv":len(row['Adverb']), "totalPoi":len(row['Pointers']), "totalMisce":len(row['others']), 
        "matchedWords_noSyn":compare_noSyn(row['groundTruthWords'],row['predictedWords']), "matchedNoun_noSyn":compare_noSyn(row['Noun'],row['predictedWords']), "matchedConj_noSyn":0, "matchedAdj_noSyn":compare_noSyn(row['Adjective'],row['predictedWords']), "matchedVerbs_noSyn":compare_noSyn(row['Verb'],row['predictedWords']), "matchedAdv_noSyn":compare_noSyn(row['Adverb'],row['predictedWords']), "matchedPoi_noSyn":compare_noSyn(row['Pointers'],row['predictedWords']), "matchedMisce_noSyn":compare_noSyn(row['others'],row['predictedWords']), "matchedSentence_noSyn":0, 
