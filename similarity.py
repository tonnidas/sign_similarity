...
for i in range(1, n+1):
  inFile = f'ira_alegria/processed_ira_alegria/srt/ira_{i}.srt'
  outFile = f'ira_alegria/processed_ira_alegria/vtt/ira_{i}_result.vtt'
...
for i in range(1, n+1):
  inFile = f'proteinas_porcentajes/processed_proteinas_porcentajes/srt/proteinas_{i}.srt'
  outFile = f'proteinas_porcentajes/processed_proteinas_porcentajes/vtt/proteinas_{i}_result.vtt'
